    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
		        '<div style="float:left">' +//1
		        	'<div class="ranges" style="float:none;width:auto;display:table-row;">' +
				        '<div class="daterangepicker_start_input">' +
					        '<label for="daterangepicker_start" style="display:inline;width:auto;margin-left:5px;"></label>' +
					        '<input class="input-mini" style="display:inline;margin:0 0 0px 4px;width:175px;" type="text" name="daterangepicker_start" value="" />' +
				        '</div>' +
				    '</div>' +
		        	'<div class="calendar second"></div>' +
		        '</div>'+
				'<div style="float:right">'+
					'<div class="ranges" style="float:none;width:auto;display:table-row;">' +
			            '<div class="daterangepicker_end_input" style="padding-left:0px">' +
			                '<label for="daterangepicker_end" style="display:inline;width:auto;margin-left:5px;"></label>' +
			                '<input class="input-mini" style="display:inline;margin:0 0 0px 4px;width:175px;" type="text" name="daterangepicker_end" value="" />' +
			            '</div>' +  
			        '</div>' +
		        	'<div class="calendar first"></div>' +
		        '</div>'+
		        '<div class="ranges" style="text-align:center;clear:both;width:100%">' +
