(function () {
    ...
    app.controller('InfoCategoryGrid', Grid);
    
    var editCtrl = "InfoCategoryEdit";
	 app.controller(editCtrl,DCtrl);
	 
	 var base = '/basetree/';
	 var editUrl = '../admin/pages/ccplus/info/info_category_edit.html';
	 var viewUrl = '../admin/pages/ccplus/info/info_category_view.html';
