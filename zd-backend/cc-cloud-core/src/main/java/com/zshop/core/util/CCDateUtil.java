...
public class CCDateUtil {
	...
	private static final LogUtil log = LogUtil.getLogger(CCDateUtil.class);
	...
	public static final SimpleDateFormat YMDFormatter2 = new SimpleDateFormat("yyyyMMdd");
    ...
    */
	...
	/**
	 ...
	 /**
		 ...
		 * @return
		 */
	  public static final String getTodayYYMMDD() {
			
			Calendar c = Calendar.getInstance();
			
			return YMDFormatter2.format(c.getTime());
