(function() {
    ...
    app.controller('CategoryGrid',InitGrid);

    var editCtrl = "CategoryGridEdit";
    app.controller(editCtrl,InitEdit);

    var base = '/food/foodcategorydetail/';
    var editUrl = '../nsAdmin/restaurantbooking/category/panel_edit.html';
    ...
    function InitEdit($scope,site,$filter,modalCode,ModalCtrl,HttpUtils,$modalInstance) {
        ...
        $scope.addSave = function () {
            if(site.code == 1){
                ...
                var imgPath=$("input[name='imgUrl']").val();
                sendData.imgUrl= imgPath;
