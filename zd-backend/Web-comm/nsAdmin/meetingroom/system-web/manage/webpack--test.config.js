...
//      publicPath:''//用npm start 时打开
    ...
    devServer: {
        ...
        port: 7070,
//      host:'192.168.118.10',//'192.168.66.32',192.168.66.56
        host:'http://192.168.91.248',//'192.168.66.32',192.168.66.56
        proxy:[
            {
         
                context:['/'],
//              target: 'http://192.168.118.10:8080/',
                target: 'http://192.168.91.248:8080/',
            changeOrigin:true,
            secure:false
          }]
    },
